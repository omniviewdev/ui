    ...
    >
      ...
      >
        <p
          style={{
            ...
            padding: '0 12px 8px',
            fontSize: 'var(--ov-font-size-caption)',
            fontWeight: 'var(--ov-font-weight-title)' as never,
          }}
        >
          Explorer
        </p>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <Sheet
          surface="raised"
          variant="ghost"
          style={{ flex: 1, padding: 16, borderRadius: 0, border: 'none' }}
        >
          <p style={{ margin: '0 0 12px', fontWeight: 'var(--ov-font-weight-title)' as never }}>
            Editor
          </p>
          {/* Inset code block */}
          <Sheet
          ...
          >
            ...
            <div style={{ paddingLeft: 16, color: 'var(--ov-color-fg-subtle)' }}>
              {'density: "comfortable",'}
            </div>
        ...
        <Sheet
          ...
          style={{
            ...
            borderRadius: 0,
            border: 'none',
            borderTop: '1px solid var(--ov-color-border-muted)',
          }}
        >
          <p
            style={{
