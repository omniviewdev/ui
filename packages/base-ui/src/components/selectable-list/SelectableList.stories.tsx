...
export const BasicCheckboxList: Story = {
  render: (args) => (
    <SelectableList selectionMode="multiple" {...args} style={{ width: 320 }}>
...
export const SingleSelectRadio: Story = {
  render: (args) => (
    <SelectableList selectionMode="single" {...args} style={{ width: 320 }}>
      <SelectableList.Viewport>
...
export const GroupedWithSelectAll: Story = {
  render: (args) => (
    <SelectableList selectionMode="multiple" {...args} style={{ width: 360 }}>
...
function DensityDemo({ density }: { density: 'compact' | 'default' | 'comfortable' }) {
  return (
    <div>
      ...
      <SelectableList selectionMode="multiple" density={density} style={{ width: 280 }}>
        <SelectableList.Viewport>
...
export const WithDescription: Story = {
  render: (args) => (
    <SelectableList selectionMode="multiple" {...args} style={{ width: 400 }}>
      <SelectableList.Viewport>
        <SelectableList.Item itemKey="read" textValue="Read">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', flex: 1, minWidth: 0 }}>
            ...
            <SelectableList.ItemDescription>
              View resources and their details
            </SelectableList.ItemDescription>
          </div>
        </SelectableList.Item>
