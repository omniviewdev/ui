...
export interface SelectableListSelectAllProps extends HTMLAttributes<HTMLDivElement> {
  children?: ReactNode;
}

export interface SelectableListSelectionSummaryProps extends Omit<
...
export interface SelectableListGroupSelectAllProps extends HTMLAttributes<HTMLDivElement> {
