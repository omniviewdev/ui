...
const RowListRoot = forwardRef<HTMLDivElement, RowListRootProps>(
  function RowListRoot(
...
const RowListHeader = forwardRef<HTMLDivElement, RowListHeaderProps>(
  function RowListHeader({ className, ...props }, ref) {
      ...
      >
        {columns.map((col) => {
          ...
          const SortIconComponent =
            sortState?.direction === 'descending' ? LuArrowDown : LuArrowUp;
...
const RowListItem = forwardRef<HTMLDivElement, RowListItemProps>(
  function RowListItem({ className, ...props }, ref) {
    return (
      <List.Item
        ref={ref}
...
const RowListCell = forwardRef<HTMLDivElement, RowListCellProps>(
  function RowListCell({ className, column, style, ...props }, ref) {
